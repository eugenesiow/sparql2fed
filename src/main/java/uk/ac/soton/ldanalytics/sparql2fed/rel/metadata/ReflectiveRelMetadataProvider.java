...
import uk.ac.soton.ldanalytics.sparql2fed.util.ReflectiveVisitor;
...
public class ReflectiveRelMetadataProvider
   ...
   * that extend {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Union}
   * or {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Filter}.</p>
   */
  ...
  reflectiveSource(final MetadataHandler target,
    ...
    // See map.put in uk.ac.soton.ldanalytics.sparql2fed.rel.metadata.ReflectiveRelMetadataProvider.apply(
    // java.lang.Class<? extends uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode>)
