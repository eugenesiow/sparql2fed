...
public interface SqlValidatorScope {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SelectScope}) which can be the
   * context for name-resolution. In scopes such as
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.validate.IdentifierNamespace}, it throws
