 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode relational expression}.</p>
 *
 * <p>Interface {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptPlanner} defines a planner,
 * and class {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.VolcanoPlanner} is an
 * implementation which uses a dynamic programming technique. It is based upon
 * the Volcano optimizer [<a href="#graefe93">1</a>].</p>
 *
 * <p>Interface {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptCost} defines a cost
 * model; class {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.VolcanoCost} is
 * the implementation for a <code>VolcanoPlanner</code>.</p>
 *
 * <p>A {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.RelSet} is a set of equivalent
 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelTraitDef}.  Manifestations of the trait
 * implement {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelTrait}. The most common example
 * of a trait is calling convention: the protocol used to receive and transmit
 * data. {@link uk.ac.soton.ldanalytics.sparql2fed.plan.ConventionTraitDef} defines the trait
 * and {@link uk.ac.soton.ldanalytics.sparql2fed.plan.Convention} enumerates the
 ...
 *     </li>
 *     <li>{@link uk.ac.soton.ldanalytics.sparql2fed.plan.Convention#NONE} means that a
 *         relational
 ...
 *     implementation of {@link uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode} should include
 *     its manifestation of the trait as part of the
 *     {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelTraitSet} passed to
 *     {@link uk.ac.soton.ldanalytics.sparql2fed.rel.AbstractRelNode}'s constructor. It may be
 ...
 *     {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.VolcanoPlanner#setRoot(uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode)}
 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.AbstractRelNode#clone()} must not assume the
 * type and quantity of traits in their trait set. In either case, the new
 * <code>RelTraitDef</code> implementation must be
 * {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.VolcanoPlanner#addRelTraitDef(uk.ac.soton.ldanalytics.sparql2fed.plan.RelTraitDef)}
 * registered with the planner.</p>
 *
 * <p>A {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.RelSubset} is a subset of a
 ...
 * <ul>
 * <li>{@code <a href="../rel/package-summary.html">uk.ac.soton.ldanalytics.sparql2fed.rel</a>}
 *     defines {@link uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode relational expressions}.
 * </li>
 * </ul>
 *
 * <h2>Details</h2>
