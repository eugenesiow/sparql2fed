 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Join} and creates
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Filter}s if those predicates can be pushed
 * to its inputs.
 *
 * <p>Uses {@link uk.ac.soton.ldanalytics.sparql2fed.rel.metadata.RelMdPredicates} to infer
 * the predicates,
 * returns them in a {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptPredicateList}
