...
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.OverScope;
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlConformance;
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlModality;
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorCatalogReader;
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorImpl;
