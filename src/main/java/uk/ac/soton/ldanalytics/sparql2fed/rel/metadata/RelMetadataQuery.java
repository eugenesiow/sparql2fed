...
public class RelMetadataQuery {
   ...
   *
   * @see #getColumnOrigins(uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode, int)
   *
   ...
   * {@link BuiltInMetadata.ColumnUniqueness#areColumnsUnique(uk.ac.soton.ldanalytics.sparql2fed.util.ImmutableBitSet, boolean)}
  ...
  /** As {@link #getAverageColumnSizes(uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode)} but
