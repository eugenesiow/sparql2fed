...
import uk.ac.soton.ldanalytics.sparql2fed.rel.core.EquiJoin;
...
import uk.ac.soton.ldanalytics.sparql2fed.sql.fun.SqlRowOperator;
...
public abstract class ReduceExpressionsRule extends RelOptRule {
  ...
  /**
   * Rule that reduces constants inside a {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Filter}.
   * If the condition is a constant, the filter is removed (if TRUE) or replaced with
   * an empty {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Values} (if FALSE or NULL).
   */
  public static class FilterReduceExpressionsRule extends ReduceExpressionsRule {
     ...
     * to an empty
     * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Values}.
     *
  ...
  /**
   * Rule that reduces constants inside a {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Project}.
   */
  ...
  /**
   * Rule that reduces constants inside a {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Join}.
   */
  ...
  /**
   * Rule that reduces constants inside a {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Calc}.
   */
