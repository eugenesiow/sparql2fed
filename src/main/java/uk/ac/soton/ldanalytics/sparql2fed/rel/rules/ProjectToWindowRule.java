 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Project}
 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalWindow}.
 * If the {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalCalc} does not contain
 * any windowed agg functions, does nothing.
 *
 * <p>There is also a variant that matches
 * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Calc} rather than {@code Project}.
 */
public abstract class ProjectToWindowRule extends RelOptRule {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Calc} that contains
   * windowed aggregates and converts it into a mixture of
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalWindow} and {@code Calc}.
   */
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Project} and that produces, in turn,
   * a mixture of {@code LogicalProject}
   * and {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalWindow}.
   */
