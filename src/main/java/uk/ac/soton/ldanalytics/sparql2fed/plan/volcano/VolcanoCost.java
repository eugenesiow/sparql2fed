...
class VolcanoCost implements RelOptCost {
  ...
  /** Implementation of {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptCostFactory}
   * that creates {@link uk.ac.soton.ldanalytics.sparql2fed.plan.volcano.VolcanoCost}s. */
