 ...
 * {@link SqlValidator#getNamespace(uk.ac.soton.ldanalytics.sparql2fed.sql.SqlNode)}, you may
...
public interface SqlValidatorNamespace {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlIdentifier} called "TIMESTAMP".
   */
