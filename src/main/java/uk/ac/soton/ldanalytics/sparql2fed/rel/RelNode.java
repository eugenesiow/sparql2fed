...
import uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptNode;
import uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptPlanner;
import uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptQuery;
 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlNode} and {@link RexNode}.</p>
 *
 ...
 * a {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelImplementor} to manage the process. Every
...
public interface RelNode extends RelOptNode, Cloneable {
   ...
   *
   * <p>Note: only {@link uk.ac.soton.ldanalytics.sparql2fed.rel.core.Correlate} should set
   * variables.
   *
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.Glossary#VISITOR_PATTERN visitor pattern} to
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.externalize.RelWriterImpl#input(String, RelNode)}
   * and
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.externalize.RelWriterImpl#item(String, Object)}
   ...
   * uk.ac.soton.ldanalytics.sparql2fed.rel.ArrayRel.ArrayReader</code>, this method returns
   * "ArrayReader".
   *
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptPlanner#addRule} for each rule, and
