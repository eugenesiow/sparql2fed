...
public class SqlSetOption extends SqlCall {
  ...
  /** Name of the option as an {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlIdentifier}
   * with one or more parts.*/
  SqlIdentifier name;

  /** Value of the option. May be a {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlLiteral} or
   * a {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlIdentifier} with one
