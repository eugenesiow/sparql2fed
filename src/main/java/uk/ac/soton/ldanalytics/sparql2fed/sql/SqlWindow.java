...
public class SqlWindow extends SqlCall {
   ...
   *
   * @see uk.ac.soton.ldanalytics.sparql2fed.rel.core.Window.Group#isAlwaysNonEmpty()
   * @see SqlOperatorBinding#getGroupCount()
   * @see uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorImpl#resolveWindow(SqlNode, uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorScope, boolean)
   */
