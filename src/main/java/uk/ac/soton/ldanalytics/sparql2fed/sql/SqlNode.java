...
import uk.ac.soton.ldanalytics.sparql2fed.sql.pretty.SqlPrettyWriter;
...
public abstract class SqlNode implements Cloneable {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlKind#OTHER} if it's nothing special.
   *
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.util.SqlVisitor visitor object}.
   *
