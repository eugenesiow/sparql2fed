...
public interface Litmus {
  /** Implementation of {@link uk.ac.soton.ldanalytics.sparql2fed.util.Litmus} that throws
  ...
  /** Implementation of {@link uk.ac.soton.ldanalytics.sparql2fed.util.Litmus} that returns
