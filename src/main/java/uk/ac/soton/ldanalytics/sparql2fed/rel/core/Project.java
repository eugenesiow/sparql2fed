 ...
 *
 * @see uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalProject
 */
public abstract class Project extends SingleRel {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.mapping.Mappings.TargetMapping#getTarget(int)}.
   *
