...
import uk.ac.soton.ldanalytics.sparql2fed.rel.metadata.CachingRelMetadataProvider;
...
import uk.ac.soton.ldanalytics.sparql2fed.util.CancelFlag;
...
public interface RelOptPlanner {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.convert.ConverterRule} and pass the
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalTableScan} representing a
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptCost}s.
   */
  ...
  /**
   * Thrown by {@link uk.ac.soton.ldanalytics.sparql2fed.plan.RelOptPlanner#findBestExp()}.
   */
