...
import uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessDate;
import uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessTime;
import uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessTimestamp;
...
abstract class SqlAbstractDateTimeLiteral extends SqlLiteral {
   ...
   * is expected to follow {@link uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessTime}
   * and {@link uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessDate}
   * semantics.
   */
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessDate} object.
   */
  ...
  /**
   * Converts this literal to a
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessTime} object.
   */
  ...
  /**
   * Converts this literal to a
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.ZonelessTimestamp} object.
   */
