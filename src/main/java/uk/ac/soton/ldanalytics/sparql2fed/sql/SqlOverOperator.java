 ...
 *
 * <ul>
 * <li>0: name of window function ({@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlCall})</li>
 *
 * <li>1: window name ({@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlLiteral}) or
