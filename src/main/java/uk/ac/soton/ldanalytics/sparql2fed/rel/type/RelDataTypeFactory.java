 ...
 * {@link uk.ac.soton.ldanalytics.sparql2fed.util.Glossary#ABSTRACT_FACTORY_PATTERN abstract factory pattern}.
...
public interface RelDataTypeFactory {
  ...
  /**
   * Creates a
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeFactory.FieldInfoBuilder}.
   */
  ...
  public static class FieldInfoBuilder implements FieldInfo {
     ...
     * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeFactory#createSqlType(uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeName)}.
     */
    ...
    /**
     * Adds a field with a type created using
     * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeFactory#createSqlType(uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeName, int)}.
     */
    ...
    /**
     * Adds a field with a type created using
     * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeFactory#createSqlType(uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeName, int, int)}.
     */
    public FieldInfoBuilder add(
