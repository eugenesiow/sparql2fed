...
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlAsOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlBinaryOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlCall;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlFilterOperator;
...
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlFunctionalOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlInternalOperator;
...
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlOverOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlPostfixOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlPrefixOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlProcedureCallOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlRankFunction;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlSampleSpec;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlSetOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlSpecialOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlUnnestOperator;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlUtil;
import uk.ac.soton.ldanalytics.sparql2fed.sql.SqlValuesOperator;
...
import uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlModality;
import uk.ac.soton.ldanalytics.sparql2fed.util.Litmus;

/**
 * Implementation of {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlOperatorTable} containing
...
public class SqlStdOperatorTable extends ReflectiveSqlOperatorTable {
   ...
   *
   * <ol>
   * <li>name of window function ({@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlCall})</li>
   * <li>window name ({@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlLiteral}) or window
