 ...
 *
 * <p>Created by {@link uk.ac.soton.ldanalytics.sparql2fed.rel.rules.ProjectToWindowRule}.
 */
public abstract class Window extends SingleRel {
  ...
  public static class Group {
     ...
     * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlAggFunction}.
     */
     ...
     * @see uk.ac.soton.ldanalytics.sparql2fed.sql.SqlWindow#isAlwaysNonEmpty()
     * @see uk.ac.soton.ldanalytics.sparql2fed.sql.SqlOperatorBinding#getGroupCount()
     * @see uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorImpl#resolveWindow(uk.ac.soton.ldanalytics.sparql2fed.sql.SqlNode, uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorScope, boolean)
     */
