...
import uk.ac.soton.ldanalytics.sparql2fed.rel.RelShuttleImpl;
...
import uk.ac.soton.ldanalytics.sparql2fed.rel.metadata.DefaultRelMetadataProvider;
import uk.ac.soton.ldanalytics.sparql2fed.rel.rules.AggregateFilterTransposeRule;
...
import uk.ac.soton.ldanalytics.sparql2fed.rel.rules.JoinProjectTransposeRule;
import uk.ac.soton.ldanalytics.sparql2fed.rel.rules.ProjectFilterTransposeRule;
...
public class RelOptMaterialization {
   ...
   * {@link #toLeafJoinForm(uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode)}.
   *
  ...
  public static RelNode tryUseStar(RelNode rel,
    ...
    RelNode rel2 = rel.accept(
        new RelShuttleImpl() {
          ...
          /** Throws a {@link uk.ac.soton.ldanalytics.sparql2fed.util.Util.FoundOne} containing
           * a {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalTableScan} on
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.logical.LogicalJoin}s are
