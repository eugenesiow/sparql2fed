...
public interface RelWriter {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode#explain(RelWriter)}.
   * Each sub-class of {@link uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode}
   * calls {@link #input(String, uk.ac.soton.ldanalytics.sparql2fed.rel.RelNode)}
