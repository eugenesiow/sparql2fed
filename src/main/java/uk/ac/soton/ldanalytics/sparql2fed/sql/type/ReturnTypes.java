...
import uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeImpl;
import uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypeSystem;
import uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelProtoDataType;
...
public abstract class ReturnTypes {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeTransforms#TO_NULLABLE}
   */
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeTransforms#TO_NULLABLE},
   * {@link uk.ac.soton.ldanalytics.sparql2fed.sql.type.SqlTypeTransforms#TO_VARYING}.
   */
   ...
   * as a {@link uk.ac.soton.ldanalytics.sparql2fed.sql.validate.SqlValidatorNamespace}, and
