...
import uk.ac.soton.ldanalytics.sparql2fed.sql.fun.SqlTrimFunction;
...
public class SqlJdbcFunctionCall extends SqlFunction {
  ...
  private static class JdbcToInternalLookupTable {
    /**
     * The {@link uk.ac.soton.ldanalytics.sparql2fed.util.Glossary#SINGLETON_PATTERN singleton}
     * instance.
     */
