...
import uk.ac.soton.ldanalytics.sparql2fed.rel.type.RelDataTypePrecedenceList;
...
import uk.ac.soton.ldanalytics.sparql2fed.util.BarfingInvocationHandler;
import uk.ac.soton.ldanalytics.sparql2fed.util.ConversionUtil;
...
public abstract class SqlUtil {
  ...
  /**
   * Creates the type of an {@link uk.ac.soton.ldanalytics.sparql2fed.util.NlsString}.
   *
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.BarfingInvocationHandler}, which will throw
   * an error.
   */
  ...
  /** Walks over a {@link uk.ac.soton.ldanalytics.sparql2fed.sql.SqlNode} tree and returns the
