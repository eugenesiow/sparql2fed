...
public abstract class Join extends BiRel {
   ...
   * {@link uk.ac.soton.ldanalytics.sparql2fed.util.Bug#upgrade(String) before version 2.0},
   ...
   * {@link SemiJoin} via
   * {@link uk.ac.soton.ldanalytics.sparql2fed.rel.rules.JoinAddRedundantSemiJoinRule}.
   *
